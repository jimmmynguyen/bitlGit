...
arduino_on_url = "http://192.168.0.107/on"  # Thay thế bằng địa chỉ IP và cổng thích hợp

# URL của máy chủ Arduino (ESP32) để tắt servo
arduino_off_url = "http://192.168.0.107/off"  # Thay thế bằng địa chỉ IP và cổng thích hợp

# URL của máy chủ Arduino (ESP32) để bật còi
arduino_coi_on_url = "http://192.168.0.107/coiOn"  # Thay thế bằng địa chỉ IP và cổng thích hợp

# URL của máy chủ Arduino (ESP32) để tắt còi
arduino_coi_off_url = "http://192.168.0.107/coiOff"  # Thay thế bằng địa chỉ IP và cổng thích hợp

# URL để gửi yêu cầu khi phát hiện khuôn mặt
arduino_face_detected_url = "http://192.168.0.107/faceDetected"  # Thay thế bằng địa chỉ IP và cổng thích hợp
...
def gen():
    ...
    thingspeak_interval =  60  # 10 phút
    ...
    def send_data_to_thingspeak(name):
      while True:
        ...
        time.sleep(thingspeak_interval)
